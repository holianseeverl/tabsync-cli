// tempo.js — track the pace/rhythm of session work
...
function sortByTempo(sessions) {
  ...
  return [...sessions].sort((a, b) => {
    const ao = a.tempo != null ? order[a.tempo] : 99;
    const bo = b.tempo != null ? order[b.tempo] : 99;
    return ao - bo;
  });
}

module.exports = { isValidTempo, setTempo, clearTempo, setTempoByName, getTempo, filterByTempo, sortByTempo };
